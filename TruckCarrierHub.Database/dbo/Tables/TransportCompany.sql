...
CREATE NONCLUSTERED INDEX [IX_Address]
    ON [dbo].[TransportCompany]([PhysicalAddressNationality] ASC, [PhysicalAddressStateCode] ASC, [PhysicalAddressCity] ASC, [LegalName] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_ZIP]
    ON [dbo].[TransportCompany]([PhysicalAddressZipCode] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_MC]
    ON [dbo].[TransportCompany]([IccDocketNumberFirst] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_TrucksAndTractors]
    ON [dbo].[TransportCompany]([TrucksAndTractors] ASC);
